...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminStatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #region İstatistik1(GetCarCount) 
            ...
            #region İstatistik2(GetLocationCount)  
            var responseMessage2 = await client.GetAsync("https://localhost:7027/api/Statistics/GetLocationCount");
            ...
            #region İstatistik3(GetAuthorCount) 
            var responseMessage3 = await client.GetAsync("https://localhost:7027/api/Statistics/GetAuthorCount");
            ...
            #region İstatistik4(GetBlogCount)
            var responseMessage4 = await client.GetAsync("https://localhost:7027/api/Statistics/GetBlogCount");
            ...
            #region İstatistik5(GetBrandCount)
            var responseMessage5 = await client.GetAsync("https://localhost:7027/api/Statistics/GetBrandCount");
            ...
            #region İstatistik6(GetAvgRentPriceForDaily)
            var responseMessage6 = await client.GetAsync("https://localhost:7027/api/Statistics/GetAvgRentPriceForDaily");
            if (responseMessage5.IsSuccessStatusCode)
            {
            ...
            #region İstatistik7(GetAvgRentPriceForWeekly)
            var responseMessage7 = await client.GetAsync("https://localhost:7027/api/Statistics/GetAvgRentPriceForWeekly");
            ...
            #region İstatistik8(GetAvgRentPriceForMonthly)
            var responseMessage8 = await client.GetAsync("https://localhost:7027/api/Statistics/GetAvgRentPriceForMonthly");
            ...
            #region İstatistik9(GetCarCountByTranmissionIsAuto)
            var responseMessage9 = await client.GetAsync("https://localhost:7027/api/Statistics/GetCarCountByTranmissionIsAuto");
            ...
            #region İstatistik10(GetBrandNameByMaxCar)
            var responseMessage10 = await client.GetAsync("https://localhost:7027/api/Statistics/GetBrandNameByMaxCar");
            ...
            #region İstatistik11(GetBlogTitleByMaxBlogComment)
            var responseMessage11 = await client.GetAsync("https://localhost:7027/api/Statistics/GetBlogTitleByMaxBlogComment");
            ...
            #region İstatistik12(GetCarCountByKmSmallerThen1000)
            var responseMessage12 = await client.GetAsync("https://localhost:7027/api/Statistics/GetCarCountByKmSmallerThen1000");
            ...
            #region İstatistik13(GetCarCountByFuelGasolineOrDiesel)
            var responseMessage13 = await client.GetAsync("https://localhost:7027/api/Statistics/GetCarCountByFuelGasolineOrDiesel");
            ...
            #region İstatistik14(GetCarCountByFuelElectric)
            var responseMessage14 = await client.GetAsync("https://localhost:7027/api/Statistics/GetCarCountByFuelElectric");
            ...
            #region İstatistik15(GetCarBrandAndModelByRentPriceDailyMax)
            var responseMessage15 = await client.GetAsync("https://localhost:7027/api/Statistics/GetCarBrandAndModelByRentPriceDailyMax");
            ...
            #region İstatistik16(GetCarBrandAndModelByRentPriceDailyMin)
            var responseMessage16 = await client.GetAsync("https://localhost:7027/api/Statistics/GetCarBrandAndModelByRentPriceDailyMin");
